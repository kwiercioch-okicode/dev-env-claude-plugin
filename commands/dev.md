---
description: "Manage dev environments with git worktrees and infrastructure. Usage: /dev [list|create|remove|switch|up|down|status] [name]"
---

Invoke the dev-env:dev-env skill to manage dev environments.
